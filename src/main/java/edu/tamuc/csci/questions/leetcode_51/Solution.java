package edu.tamuc.csci.questions.leetcode_51;
...
//    }
    ...
    void dfs(long colTaken, long propL, long propR, int row) {
        ...
        long avail = (~(colTaken | propL | propR)) & maxChoices;
        while (avail > 0) {
            long p = avail & -avail; //lsb
            int k = 0;
